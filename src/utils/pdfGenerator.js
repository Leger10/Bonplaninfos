...
export const generateSalarySlip = (data) => {
  ...
  doc.setFontSize(10);
  doc.text("Document officiel certifié", pageWidth / 2, 40, {
    align: "center",
  });
  ...
  doc.setFontSize(12);
  doc.setFont("helvetica", "bold");
  doc.text("INFORMATIONS ADMINISTRATEUR", pageWidth / 2, y, {
    align: "center",
  });
  y += 10;
  ...
  doc.text(
    personalScore.toFixed(2).toString(),
    pageWidth - margin - 5,
    y + 24,
    { align: "right" },
  );
  ...
  doc.setFontSize(12);
  doc.setFont("helvetica", "bold");
  doc.text("DÉTAIL DU CALCUL DU SALAIRE", pageWidth / 2, y, {
    align: "center",
  });
  y += 10;
  ...
  addTableRow(
    doc,
    y,
    "Volume total des ventes Zone",
    "100%",
    formatCurrency(volumeZone),
  );
  y += 8;
  ...
  addTableRow(
    doc,
    y,
    "Commission Plateforme (Base de calcul)",
    "5%",
  ...
  addTableRow(
    doc,
    y,
    `Part Administrateur (Licence ${licenseRate}%)`,
    `${licenseRate}%`,
    formatCurrency(adminPart),
  );
  y += 8;
  ...
  addTableRow(
    doc,
    y,
    "Score de Performance (Multiplicateur)",
  ...
  // Montant principal
  doc.setFontSize(28);
  doc.text(`${formatCurrency(netSalary)} FCFA`, pageWidth / 2, y + 20, {
    align: "center",
  });
  ...
  doc.setFontSize(9);
  doc.text(
    "BONPLANINFOS - Plateforme d'information et de services",
    pageWidth / 2,
    278,
    { align: "center" },
  );
  doc.text(
    "support@bonplaninfos.net | www.bonplaninfos.net",
    pageWidth / 2,
    285,
    { align: "center" },
  );
  doc.text(
    "© 2025 Tous droits réservés - Document confidentiel",
    pageWidth / 2,
    292,
    { align: "center" },
  );
...
export const generateEarningsSlip = (data) => {
  ...
  doc.setFontSize(16);
  doc.text("RELEVÉ DE GAINS ORGANISATEUR", pageWidth / 2, 35, {
    align: "center",
  });
  doc.setFontSize(10);
  doc.text("Document officiel de revenus", pageWidth / 2, 40, {
    align: "center",
  });
  ...
  doc.rect(
    margin + 10,
    y + 20,
    (progressWidth / 100) * (pageWidth - 2 * margin - 20),
    6,
    "F",
  );
  ...
  doc.text(`- ${formatCurrency(fees)} FCFA`, pageWidth - margin - 10, y + 5, {
    align: "right",
  });
  ...
  doc.text(`${formatCurrency(netEarnings)} FCFA`, pageWidth - margin - 10, y, {
    align: "right",
  });
  ...
  doc.setFontSize(9);
  doc.text(
    "BONPLANINFOS - Plateforme d'événements et billetterie",
    pageWidth / 2,
    278,
    { align: "center" },
  );
...
export const generatePaymentReceipt = (data) => {
  ...
  doc.setFont("helvetica", "normal");
  doc.text(
    "Ce document certifie que le paiement a été effectué avec succès.",
    pageWidth / 2,
    y,
    { align: "center" },
  );
  ...
  doc.setTextColor(255, 255, 255);
  doc.setFontSize(9);
  doc.text("BONPLANINFOS - Service financier", pageWidth / 2, 278, {
    align: "center",
  });
  doc.text(
    "support@bonplaninfos.net | www.bonplaninfos.net",
  ...
  doc.text("© 2025 - Document généré automatiquement", pageWidth / 2, 292, {
    align: "center",
  });
