        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {userPacks.map((pack, index) => (
              ...
              >
                <Card
                  className={`flex flex-col h-full glass-effect hover:border-primary transition-all ${pack.id === "vip" ? "border-primary" : "border-border"}`}
                >
                  <CardHeader className="text-center">
                    ...
                    <div className="my-4">
                      <span className="text-5xl font-bold">
                        {pack.coins +
                          (pack.bonus?.match(/\d+/g)?.map(Number)[0] || 0)}
                      </span>
            ...
            {businessPacks.map((pack, index) => (
              ...
              >
                <Card className="flex flex-col h-full glass-effect hover:border-primary transition-all">
                  ...
                  <CardFooter>
                    <Button className="w-full" onClick={pack.action}>
                      {pack.actionText}
                    </Button>
                  </CardFooter>
                </Card>
