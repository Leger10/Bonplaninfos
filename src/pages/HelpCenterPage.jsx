...
const HelpCenterPage = () => {
  ...
  const faqSections = useMemo(
    () => t("help_center.faq_sections", { returnObjects: true }) || {},
    [t],
  );
      ...
      if (
        ...
        for (const key in section) {
          if (key.startsWith("q")) {
            ...
            matchingQuestions[key.replace("q", "a")] =
              section[key.replace("q", "a")];
          }
        }
      } else {
        for (const key in section) {
          if (key.startsWith("q")) {
            ...
            if (
              question &&
              answer &&
              (question.toLowerCase().includes(lowercasedFilter) ||
                answer.toLowerCase().includes(lowercasedFilter))
            ) {
  ...
  const isFaqDataValid =
    faqSections &&
    typeof faqSections === "object" &&
    Object.keys(faqSections).length > 0;

  const contactMethods = [
    {
      icon: <Mail />,
      title: t("help_center.email"),
      desc: t("help_center.emailDesc"),
      buttonText: t("help_center.writeUs"),
      href: "mailto:support@bonplaninfos.net",
    },
    {
      icon: <MessageSquare />,
      title: t("help_center.chat"),
      desc: t("help_center.chatDesc"),
      buttonText: t("help_center.startChat"),
      href: "https://chat.whatsapp.com/IcR0TttLYpU1lJXr3ifyvH",
    },
    {
      icon: <Phone />,
      title: t("help_center.phone"),
      desc: t("help_center.phoneDesc"),
      buttonText: t("help_center.call"),
      href: "tel:+2250712275374",
    },
  ];
        ...
        <section className="search-section">
          <div className="container">
            <div className="search-container">
              ...
              <Input
                type="text"
                placeholder={t("help_center.searchPlaceholder")}
            ...
            <div className="max-w-4xl mx-auto">
              {isFaqDataValid ? (
                ...
                <p className="text-center text-muted-foreground">
                  Le contenu du centre d'aide est en cours de chargement...
                </p>
              )}
            </div>
          </div>
                ...
                >
                  <Card className="contact-card h-full">
                    ...
                    <CardContent className="flex flex-col flex-grow">
                      <p className="contact-description flex-grow">
                        {method.desc}
                      </p>
