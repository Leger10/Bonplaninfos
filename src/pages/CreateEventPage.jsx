...
const CreateEventPage = () => {
  ...
  const isAllowedToCreateSimpleEvent =
    userProfile &&
            ...
            return (
              ...
              >
                ...
                >
                  <CardHeader>
                    <div
                      className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 bg-white/20`}
                    >
                    ...
                    <CardTitle className="text-lg flex items-center justify-between">
                      ...
                      {type.restricted && (
                        <ShieldCheck
                          ...
                          title={t("createEvent.restricted_tooltip")}
                        />
                      )}
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    ...
                    <Button
                      variant="outline"
                      className="w-full justify-between group hover:bg-white/20 text-white border-white/50"
                    >
