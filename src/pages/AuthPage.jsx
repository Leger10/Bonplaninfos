    ...
    return (
      ...
      >
        ...
        <p className="text-muted-foreground">
          Votre demande de réactivation a été transmise à l'administration. Vous
          serez contacté par email ({initialEmail}) dès qu'elle sera traitée.
        </p>
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-muted-foreground">
        Votre compte a été désactivé par l'administration. Veuillez remplir ce
        formulaire pour demander une réactivation.
      </p>
  ...
  const handleResendConfirmation = async () => {
    ...
    try {
      ...
      if (msg.includes("rate limit"))
        msg = "Veuillez patienter avant de renvoyer un email.";
  ...
  const handleSubmit = async (e) => {
    ...
    if (isLogin) {
      ...
      if (error) {
        ...
        setError(
          "Un utilisateur avec cet email existe déjà mais n'est pas confirmé.",
        );
        setShowResendLink(true);
      } else {
        setShowConfirmationMessage(true);
    ...
    <>
      <Helmet>
        ...
        <meta
          ...
          content={
            isLogin
              ? t("auth.login.meta_description")
              : t("auth.register.meta_description")
          }
        />
      </Helmet>
            ...
            {showDeactivatedForm ? (
              ...
              >
                ...
                <h1 className="text-2xl font-bold font-heading text-primary">
                  {t("auth.register.confirmation_email_title")}
                </h1>
                <Alert className="bg-blue-50 border-blue-200 text-left">
                  <AlertDescription className="text-blue-800">
                    Un email de confirmation a été envoyé à{" "}
                    <strong>{email}</strong>. Veuillez cliquer sur le lien pour
              ...
              >
                ...
                {error && (
                  <Alert
                    variant="destructive"
                    className="mb-4 animate-in shake"
                  >
                        ...
                        >
                          ...
                          <Select onValueChange={setCountry} value={country || undefined}>
                            <SelectTrigger autoComplete="country-name">
                              <SelectValue
                                placeholder={t(
                                  "auth.select_country_placeholder",
                                )}
                              />
                            </SelectTrigger>
                            <SelectContent>
                        ...
                        >
                          ...
                          >
                            <SelectTrigger autoComplete="address-level2">
                              <SelectValue
                                placeholder={t("auth.select_city_placeholder")}
                              />
                            </SelectTrigger>
                            <SelectContent>
                              {cities.map((cityName) => (
                        ...
                        >
                          ...
                          <Select onValueChange={setRole} value={role}>
                            <SelectTrigger autoComplete="off">
                              <SelectValue
                                placeholder={t("auth.choose_role_placeholder")}
                              />
                            </SelectTrigger>
                            <SelectContent>
                ...
                <p className="mt-6 text-center text-sm">
                  {isLogin
                    ? t("auth.login.switch_text")
                    : t("auth.register.switch_text")}
                  <Button
                    variant="link"
                    onClick={toggleForm}
                  ...
                  >
                    {isLogin
                      ? t("auth.register.switch_button")
                      : t("auth.login.switch_button")}
                  </Button>
                </p>
              </motion.div>
            )}
