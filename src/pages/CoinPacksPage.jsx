...
const CoinPacksPage = () => {
  ...
  const handlePurchase = (pack) => {
    ...
    console.log(
      `Achat pack ${pack.name} - Redirection vers: ${pack.paymentLink}`,
    );
  ...
  const handleCustomAmountPurchase = () => {
    ...
    console.log(
      `Paiement personnalisé - Redirection vers: ${CUSTOM_PAYMENT_LINK}`,
    );
      ...
      <div className="max-w-7xl mx-auto space-y-10 sm:space-y-16">
        ...
        >
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-300 max-w-2xl mx-auto px-2">
            Choisis ton pack, recharge ton compte via les réseaux mobile de ton
            pays et profite des événements exclusifs 🔥
          </p>
            ...
            return (
              ...
              >
                ...
                <div className="p-4 sm:p-6 text-center border-b border-gray-800 bg-gradient-to-b from-gray-900 to-gray-950 flex-grow">
                  <div
                    className={`w-12 h-12 sm:w-16 sm:h-16 mx-auto bg-gray-800 rounded-full flex items-center justify-center mb-3 sm:mb-4 shadow group-hover:scale-105 transition-transform duration-300 ${pack.color} shadow-current/10`}
                  >
            ...
            <div className="flex flex-col items-center gap-4 sm:gap-6 relative z-10">
              ...
              <div className="flex-grow text-center">
                ...
                <p className="text-gray-400 text-xs sm:text-sm mb-4">
                  Budget spécifique ? Renseigner votre montant personnalisé !
                </p>
                  ...
                  <div className="mt-3 p-2 bg-gray-800/50 rounded border border-gray-700">
                    <p className="text-xs sm:text-sm font-medium text-gray-300">
                      ...
                      <span className="font-bold text-yellow-300">
                        {Math.floor(customAmount / 10).toLocaleString()} pièces
                      </span>
                    </p>
                  </div>
                )}
