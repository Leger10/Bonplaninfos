...
import { Zap, Star, Crown, Sparkles, Coins, Check, Calculator, ArrowRight } from 'lucide-react';
...
const CreditPacksPage = () => {
    ...
    const handlePurchase = (pack) => {
        ...
        // Direct redirection to the unique MoneyFusion link for this pack
    ...
    const handleCustomAmountPurchase = () => {
        ...
        // Redirect to the custom amount link
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="p-8 text-center border-b border-gray-800 bg-gray-900/30 flex-grow">
                                    <div className={`w-16 h-16 mx-auto bg-gray-800 rounded-full flex items-center justify-center mb-4 shadow-lg group-hover:scale-110 transition-transform duration-300 ${pack.color}`}>
                                        <Icon className="w-8 h-8" />
                                    </div>
                                    <h3 className="text-2xl font-bold text-white mb-2">{pack.name}</h3>
                                    <div className="flex items-baseline justify-center mb-1">
                                        <span className="text-4xl font-extrabold text-white">{pack.amount.toLocaleString()}</span>
                                        <span className="text-lg font-medium text-slate-300 ml-1">FCFA</span>
                                    </div>
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-8">
                            ...
                            <div className="flex-grow text-center md:text-left">
                                ...
                                <p className="text-gray-400 text-sm mb-4">
                                    Vous souhaitez créditer un montant spécifique ? Utilisez notre outil personnalisé.
                                </p>
                                ...
                                {customAmount > 0 && (
                                    <p className="mt-3 text-sm font-medium text-indigo-400">
                                        Vous recevrez environ <span className="font-bold">{Math.floor(customAmount / 10)}</span> Crédits
                                    </p>
                                )}
                            </div>
                        </div>
