...
import { ArrowLeft, Calendar, MapPin, Phone, Trash2, Loader2, Lock, Coins, ExternalLink, QrCode, BarChart, AlertTriangle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6"><Button variant="ghost" onClick={() => navigate(-1)}><ArrowLeft className="w-4 h-4 mr-2" />Retour</Button></div>
