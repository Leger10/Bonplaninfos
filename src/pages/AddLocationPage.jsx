...
const AddLocationPage = () => {
  ...
  useEffect(() => {
    const fetchTypes = async () => {
      ...
      if (error) {
        toast({
          title: "Erreur",
          description: "Impossible de charger les types de lieux.",
        });
      } else {
  ...
  const handleFileChange = (e) => {
    if (e.target.files.length > 5) {
      toast({
        title: "Trop d'images",
        description: "Vous ne pouvez téléverser que 5 images maximum.",
        variant: "destructive",
      });
      return;
    }
  ...
  const removeImage = (indexToRemove) => {
    setFormData((prev) => ({
      ...prev,
      images_files: prev.images_files.filter(
  ...
  const handleSubmit = async (e) => {
    ...
    if (!user) {
      toast({
        ...
        description: "Veuillez vous connecter pour ajouter un lieu.",
        variant: "destructive",
      });
      navigate("/auth");
      return;
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast({
        title: "Erreur",
        description: "Impossible de vider le formulaire.",
        variant: "destructive",
      });
    } finally {
          ...
          <CardHeader>
            <div className="flex justify-between items-center">
              <div>
                ...
                <CardDescription>
                  Partagez vos bons plans avec la communauté.
                </CardDescription>
              </div>
              {hasData && (
                <Button
              ...
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <Card className="w-full max-w-md mx-4">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Êtes-vous sûr de vouloir supprimer toutes les données du
                      formulaire ? Cette action est irréversible.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
