...
const DocumentationPage = () => {
  ...
  const downloadContract = (type) => {
    ...
    switch (type) {
      case "ville":
        ...
        y += 7;
        doc.text(
          `Email : ${BONPLANINFOS_INFO.email} / Tél: ${BONPLANINFOS_INFO.telephone}`,
          25,
          y,
        );
        y += 10;
        ...
        doc.setFontSize(9);
        doc.text(
          "Le présent contrat a pour objet de conférer au Concessionnaire le droit exclusif",
          20,
          y,
        );
        y += 5;
        doc.text(
          "d'exploiter la plateforme BonPlanInfos dans la ville de : _________________________",
          20,
          y,
        );
        y += 10;
        ...
        doc.setFontSize(9);
        doc.text(
          "Le territoire concédé est strictement limité à la ville mentionnée ci-dessus.",
          20,
          y,
        );
        y += 5;
        doc.text(
          "Toute exploitation hors de ce périmètre est interdite sans autorisation écrite du Concédant.",
          20,
          y,
        );
        y += 10;
        ...
        doc.setFontSize(9);
        doc.text(
          "Le présent contrat est conclu pour une durée de deux (2) ans, à compter du :",
          20,
          y,
        );
        y += 5;
        doc.text(
          " _________________________, renouvelable sous réserve de performance.",
          20,
          y,
        );
        y += 10;
        ...
        doc.setFontSize(9);
        doc.text(
          "Le Concessionnaire bénéficie d’une exclusivité territoriale urbaine pendant la durée du contrat.",
          20,
          y,
        );
        y += 10;
        ...
        doc.setFontSize(9);
        doc.text(
          "Le Concessionnaire verse un droit d’entrée unique et non remboursable de : 1 000 000 FCFA",
          20,
          y,
        );
        y += 5;
        ...
        doc.setFontSize(9);
        doc.text(
          "Le Concessionnaire perçoit : 20 % des revenus issus des 5 % de commission",
          20,
          y,
        );
        y += 5;
        ...
        doc.setFontSize(9);
        doc.text(
          "• Révocation pour inaction/sous-performance : remboursement de 50% du droit d'entrée",
          20,
          y,
        );
        y += 5;
      ...
      case "region":
        ...
        docRegion.text(
          "(Licence territoriale régionale BonPlanInfos)",
          20,
          yRegion,
        );
        yRegion += 15;
        ...
        yRegion += 7;
        docRegion.text(
          `Représentée par : ${BONPLANINFOS_INFO.responsable}`,
          25,
          yRegion,
        );
        yRegion += 7;
        ...
        yRegion += 7;
        docRegion.text(
          `Siège social : ${BONPLANINFOS_INFO.siege}`,
          25,
          yRegion,
        );
        yRegion += 7;
        ...
        yRegion += 7;
        docRegion.text(
          "Téléphone / Email : _________________________",
          25,
          yRegion,
        );
        yRegion += 7;
        ...
        docRegion.text(
          "Le présent contrat confère au Concessionnaire l'exclusivité régionale",
          20,
          yRegion,
        );
        yRegion += 5;
        docRegion.text(
          "d'exploitation de BonPlanInfos sur la région de : _________________________",
          20,
          yRegion,
        );
        yRegion += 10;
        ...
        docRegion.setFontSize(9);
        docRegion.text(
          "Durée du contrat : trois (3) ans, à compter du : _________________________",
          20,
          yRegion,
        );
        yRegion += 10;
        ...
        docRegion.setFontSize(9);
        docRegion.text(
          "Le Concessionnaire verse un droit d’entrée unique de : 3 000 000 FCFA",
          20,
          yRegion,
        );
        yRegion += 5;
        ...
        yRegion += 5;
        docRegion.text(
          "Mode de paiement : _________________________",
          20,
          yRegion,
        );
        yRegion += 10;
        ...
        docRegion.setFontSize(9);
        docRegion.text(
          "Le Concessionnaire perçoit : 30 % des revenus plateforme (5 %)",
          20,
          yRegion,
        );
        yRegion += 5;
        ...
        yRegion += 5;
        docRegion.text(
          "• Démission volontaire : aucun remboursement",
          20,
          yRegion,
        );
        yRegion += 15;
      ...
      case "pays":
        ...
        docPays.text(
          "Le Concédant accorde au Concessionnaire l'exclusivité nationale",
          20,
          yPays,
        );
        yPays += 5;
        docPays.text(
          "d'exploitation de la plateforme BonPlanInfos dans le pays suivant :",
          20,
          yPays,
        );
        yPays += 5;
        ...
        docPays.setFontSize(9);
        docPays.text(
          "Contrat conclu pour une durée de cinq (5) ans, à compter du : _________________________",
          20,
          yPays,
        );
        yPays += 10;
        ...
        docPays.setFontSize(9);
        docPays.text(
          "Le Concessionnaire verse un droit d’entrée unique de : _________ FCFA",
          20,
          yPays,
        );
        yPays += 5;
        docPays.text(
          "(entre 5 000 000 et 10 000 000 FCFA selon le pays)",
          25,
          yPays,
        );
        yPays += 5;
        ...
        docPays.setFontSize(9);
        docPays.text(
          "Le Concessionnaire perçoit : 40 % des revenus plateforme (5 %)",
          20,
          yPays,
        );
        yPays += 5;
        ...
        docPays.setFontSize(9);
        docPays.text(
          "La marque, la technologie et les données restent la propriété exclusive de BonPlanInfos.",
          20,
          yPays,
        );
        yPays += 10;
        ...
        yPays += 5;
        docPays.text(
          "• Faute grave ou atteinte à la marque : résiliation immédiate",
          20,
          yPays,
        );
        yPays += 10;
        ...
        docPays.setFontSize(9);
        docPays.text(
          "Le présent contrat est régi par le droit OHADA.",
          20,
          yPays,
        );
        yPays += 15;
  ...
  const downloadOrganizerContract = () => {
    ...
    doc.setFontSize(9);
    doc.text(
      "Le présent contrat a pour objet de définir les conditions dans lesquelles la plateforme",
      20,
      y,
    );
    y += 5;
    doc.text(
      "BonPlanInfos met à disposition de l'Organisateur des outils digitaux lui permettant :",
      20,
      y,
    );
    y += 7;
    ...
    y += 7;
    doc.text(
      `BonPlanInfos (représenté par ${BONPLANINFOS_INFO.responsable}, ${BONPLANINFOS_INFO.fonction})`,
      20,
      y,
    );
    y += 5;
    doc.text(
      "agit exclusivement en tant que prestataire technique et intermédiaire de paiement.",
      20,
      y,
    );
    y += 12;
    ...
    doc.setFontSize(9);
    doc.text(
      "BonPlanInfos n'est ni organisateur, ni co-organisateur des événements publiés.",
      20,
      y,
    );
    y += 5;
    doc.text(
      "L'Organisateur est seul responsable de la conception, de l'organisation,",
      20,
      y,
    );
    y += 5;
    ...
    y += 5;
    doc.text(
      "Aucun lien de subordination, de partenariat juridique ou d'association",
      20,
      y,
    );
    y += 5;
    ...
    y += 5;
    doc.text(
      "• disposer des autorisations légales nécessaires à l'organisation de son événement",
      25,
      y,
    );
    y += 5;
    doc.text(
      "• respecter les lois et règlements en vigueur dans son pays",
      25,
      y,
    );
    y += 7;
    doc.text(
      "BonPlanInfos se réserve le droit de refuser ou suspendre tout compte organisateur",
      20,
      y,
    );
    y += 5;
    ...
    y += 6;
    doc.text(
      "Les paiements sont collectés via les moyens disponibles sur la plateforme.",
      25,
      y,
    );
    y += 5;
    ...
    y += 5;
    doc.text(
      "Les retraits sont effectués selon les modalités techniques définies par BonPlanInfos.",
      25,
      y,
    );
    y += 12;
    ...
    y += 5;
    doc.text(
      "• de la délivrance des prestations promises aux participants",
      25,
      y,
    );
    y += 5;
    ...
    doc.setFontSize(9);
    doc.text(
      "L'Organisateur garantit que le contenu publié ne viole aucun droit",
      20,
      y,
    );
    y += 5;
    ...
    doc.setFontSize(9);
    doc.text(
      "En cas d'annulation ou de report, l'Organisateur est seul responsable",
      20,
      y,
    );
    y += 5;
    doc.text(
      "de l'information des participants et des modalités de remboursement.",
      20,
      y,
    );
    y += 12;
    ...
    doc.setFontSize(9);
    doc.text(
      "BonPlanInfos se réserve le droit de suspendre temporairement ou",
      20,
      y,
    );
    y += 5;
    doc.text(
      "définitivement un compte organisateur en cas de suspicion de fraude.",
      20,
      y,
    );
    y += 12;
    ...
    doc.setFontSize(9);
    doc.text(
      "BonPlanInfos ne pourra être tenue responsable des pertes indirectes,",
      20,
      y,
    );
    y += 5;
    ...
    doc.setFontSize(9);
    doc.text(
      "En créant un compte Organisateur et en publiant un événement sur BonPlanInfos,",
      20,
      y,
    );
    y += 5;
    doc.text(
      "l'Organisateur reconnaît avoir lu, compris et accepté sans réserve le présent contrat.",
      20,
      y,
    );
    y += 10;
      ...
      <div className="md:hidden sticky top-0 z-50 bg-[#111111] border-b border-gray-800 p-4">
        <div className="flex items-center justify-between">
          ...
          <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
            ...
            <SheetContent
              side="left"
              className="bg-[#111111] border-r border-gray-800 w-[280px] p-0"
            >
              ...
              <div className="p-4 mt-auto border-t border-gray-800">
                <div className="bg-gradient-to-br from-blue-900/40 to-purple-900/40 p-4 rounded-lg border border-blue-800/30">
                  <p className="text-xs text-blue-300 mb-2 font-bold">
                    Besoin d'aide ?
                  </p>
                  <Button
                    size="sm"
        ...
        <div className="max-w-5xl mx-auto space-y-8 md:space-y-12">
          ...
          <div className="relative rounded-xl md:rounded-2xl overflow-hidden bg-gradient-to-br from-gray-900 via-[#0A0A0A] to-gray-900 border border-gray-800 p-6 md:p-8 lg:p-12 mb-6 md:mb-12">
            <div className="absolute inset-0 opacity-5">
              <img
                src="https://images.unsplash.com/photo-1663124178716-2078c384c24a"
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm md:text-base lg:text-lg text-gray-400 max-w-2xl">
                Tout savoir sur le fonctionnement, les règles financières et les
                protocoles de sécurité de BonPlanInfos.
              </p>
              <div className="mt-3 md:mt-4 p-2 md:p-3 bg-blue-900/30 border border-blue-500/30 rounded-lg inline-block">
                <p className="text-xs md:text-sm text-blue-300">
                  <span className="font-bold">Responsable légal :</span>{" "}
                  {BONPLANINFOS_INFO.responsable} - {BONPLANINFOS_INFO.fonction}
                </p>
              </div>
            </div>
          </div>
          ...
          <section
            id="overview"
            className="space-y-3 md:space-y-4 scroll-mt-16 md:scroll-mt-4"
          >
            ...
            <p className="text-sm md:text-base lg:text-lg text-gray-400 leading-relaxed">
              BonPlanInfos est une plateforme sécurisée panafricaine permettant
              l'organisation d'événements (billetterie, tombola, votes, location
              de stands). Pour garantir la sécurité des fonds et la confiance
          ...
          <section
            id="fund-release"
            className="space-y-4 md:space-y-6 scroll-mt-16 md:scroll-mt-4"
          >
            <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-white flex items-center gap-2 md:gap-3">
            ...
            <p className="text-sm md:text-base text-gray-400">
              Les revenus générés sont placés sous séquestre (Escrow) et
              débloqués progressivement selon des critères stricts.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              <Card className="bg-[#111111] border-gray-800 hover:border-blue-500/30 transition-colors">
                <CardContent className="p-4 md:p-6">
                  <Badge
                    variant="outline"
                    className="border-blue-500/30 text-blue-400 bg-blue-500/10 mb-2 text-xs"
                  >
                    Étape 1
                  </Badge>
                  <h3 className="font-bold text-base md:text-lg text-white mb-1 md:mb-2">
                    Démarrage (20-30%)
                  </h3>
                  <p className="text-xs md:text-sm text-gray-400">
                    Débloqué après vérification d'identité (KYC) et début des
              ...
              <Card className="bg-[#111111] border-gray-800 hover:border-purple-500/30 transition-colors">
                <CardContent className="p-4 md:p-6">
                  <Badge
                    variant="outline"
                    className="border-purple-500/30 text-purple-400 bg-purple-500/10 mb-2 text-xs"
                  >
                    Étape 2
                  </Badge>
                  <h3 className="font-bold text-base md:text-lg text-white mb-1 md:mb-2">
                  ...
                  <p className="text-xs md:text-sm text-gray-400">
                    Débloqué le jour de l'événement ou après atteinte de 50% des
                    objectifs de vente.
                  </p>
                </CardContent>
              </Card>
              <Card className="bg-[#111111] border-gray-800 hover:border-green-500/30 transition-colors sm:col-span-2 lg:col-span-1">
                <CardContent className="p-4 md:p-6">
                  <Badge
                    variant="outline"
                    className="border-green-500/30 text-green-400 bg-green-500/10 mb-2 text-xs"
                  >
                    Étape 3
                  </Badge>
                  <h3 className="font-bold text-base md:text-lg text-white mb-1 md:mb-2">
                  ...
                  <p className="text-xs md:text-sm text-gray-400">
                    Débloqué après validation des critères spécifiques à chaque
                    type d'événement.
                  </p>
                </CardContent>
              </Card>
          ...
          >
            ...
            <Tabs defaultValue="ticketing" className="w-full">
              <TabsList className="bg-[#111111] border border-gray-800 p-1 flex flex-wrap h-auto">
                <TabsTrigger
                  value="ticketing"
                  className="data-[state=active]:bg-blue-600 data-[state=active]:text-white text-xs md:text-sm py-1.5 px-2 md:px-3"
                >
                    ...
                    <div className="space-y-2 md:space-y-3">
                      <div className="flex items-start gap-2 md:gap-3">
                        ...
                        <p className="text-xs md:text-sm text-gray-400">
                          ...
                          Minimum 30% des billets vendus doivent être scannés
                          (QR code unique)
                        </p>
                      </div>
                      <div className="flex items-start gap-2 md:gap-3">
                        ...
                        <p className="text-xs md:text-sm text-gray-400">
                          ...
                          Statut = EN_VÉRIFICATION, fonds bloqués
                        </p>
                      </div>
                      <div className="flex items-start gap-2 md:gap-3">
                        ...
                        <p className="text-xs md:text-sm text-gray-400">
                          ...
                          Statut = VALIDÉ, déblocage des fonds
                        </p>
                      </div>
                    </div>
                  </CardContent>
                    ...
                    <div className="space-y-2 md:space-y-3">
                      <div className="flex items-start gap-2 md:gap-3">
                        ...
                        <p className="text-xs md:text-sm text-gray-400">
                          ...
                          Validation via réservation, code ou numéro
                        </p>
                      </div>
                      <div className="flex items-start gap-2 md:gap-3">
                        <div className="w-1.5 h-1.5 md:w-2 md:h-2 bg-purple-500 rounded-full mt-1.5 md:mt-2"></div>
                        <p className="text-xs md:text-sm text-gray-400">
                          ...
                          Bouton "Présent" activé par l'exposant
                        </p>
                      </div>
                      <div className="flex items-start gap-2 md:gap-3">
                        <div className="w-1.5 h-1.5 md:w-2 md:h-2 bg-green-500 rounded-full mt-1.5 md:mt-2"></div>
                        <p className="text-xs md:text-sm text-gray-400">
                          ...
                          Seuil minimum de présences atteint
                        </p>
                      </div>
                    </div>
                  </CardContent>
                  ...
                  <CardContent className="p-4 md:p-6">
                    ...
                    <div className="space-y-3 md:space-y-4">
                      ...
                      <div className="bg-gray-800/50 p-3 md:p-4 rounded-lg">
                        <h4 className="font-bold text-white mb-2 md:mb-3 text-sm md:text-base">
                          🔒 Workflow sécurisé :
                        </h4>
                        <ol className="space-y-2 md:space-y-3">
                          <li className="flex items-start gap-2 md:gap-3 text-xs md:text-sm">
                            <span className="bg-gray-700 text-white w-5 h-5 md:w-6 md:h-6 rounded-full flex items-center justify-center text-xs flex-shrink-0">
                              1
                            </span>
                            <span className="text-gray-400">
                              Vente des tickets activée
                            </span>
                          </li>
                          <li className="flex items-start gap-2 md:gap-3 text-xs md:text-sm">
                            <span className="bg-gray-700 text-white w-5 h-5 md:w-6 md:h-6 rounded-full flex items-center justify-center text-xs flex-shrink-0">
                            ...
                            <span className="text-gray-400">
                              Dépôt du lot physique au siège BonPlanInfos{" "}
                              <span className="text-yellow-400">OU</span>{" "}
                              versement de la valeur financière équivalente
                            </span>
                          </li>
                          <li className="flex items-start gap-2 md:gap-3 text-xs md:text-sm">
                            <span className="bg-gray-700 text-white w-5 h-5 md:w-6 md:h-6 rounded-full flex items-center justify-center text-xs flex-shrink-0">
                          ...
                          <li className="flex items-start gap-2 md:gap-3 text-xs md:text-sm">
                            ...
                            <span className="text-gray-400">
                              Bouton "Lancer le tirage" activé
                            </span>
                          </li>
                          <li className="flex items-start gap-2 md:gap-3 text-xs md:text-sm">
                            <span className="bg-gray-700 text-white w-5 h-5 md:w-6 md:h-6 rounded-full flex items-center justify-center text-xs flex-shrink-0">
                          ...
                          <li className="flex items-start gap-2 md:gap-3 text-xs md:text-sm">
                            ...
                            <span className="text-gray-400">
                              Remise du lot par équipe BonPlanInfos +
                              organisateur
                            </span>
                          </li>
                          <li className="flex items-start gap-2 md:gap-3 text-xs md:text-sm">
                            ...
                            <span className="text-gray-400">
                              Gagnant marqué ={" "}
                              <span className="text-green-400">LOT_REÇU</span>
                            </span>
                          </li>
                          <li className="flex items-start gap-2 md:gap-3 text-xs md:text-sm">
                            <span className="bg-gray-700 text-white w-5 h-5 md:w-6 md:h-6 rounded-full flex items-center justify-center text-xs flex-shrink-0">
                            ...
                            <span className="text-gray-400 font-semibold">
                              Autorisation du retrait final des fonds
                            </span>
                          </li>
                        </ol>
                      </div>
                      <p className="text-red-400 text-xs md:text-sm flex items-center gap-1 md:gap-2 mt-1 md:mt-2">
                        ...
                        <span>
                          Sans dépôt du lot, vos gains disponibles ne peuvent
                          pas être retirés sans la remise du lot aux gagnantx
                          "Les retraits"seront validé après remise du lot aux
                          gagnants.
                        </span>
                      </p>
                    </div>
                    ...
                    <div className="space-y-2 md:space-y-3">
                      <div className="flex items-start gap-2 md:gap-3">
                        ...
                        <p className="text-xs md:text-sm text-gray-400">
                          ...
                          Les votes payants sont placés sous séquestre
                        </p>
                      </div>
                      <div className="flex items-start gap-2 md:gap-3">
                        <div className="w-1.5 h-1.5 md:w-2 md:h-2 bg-blue-500 rounded-full mt-1.5 md:mt-2"></div>
                      ...
                      <div className="ml-4 md:ml-6 space-y-1 md:space-y-2">
                        <p className="text-xs md:text-sm text-gray-400">
                          • Fin officielle du vote
                        </p>
                        <p className="text-xs md:text-sm text-gray-400">
                          • Vérification absence de fraude
                        </p>
                        <p className="text-xs md:text-sm text-gray-400">
                      ...
                      <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-2 md:p-3 mt-2">
                        <p className="text-red-400 text-xs md:text-sm flex items-center gap-1 md:gap-2">
                          <AlertCircle className="w-3 h-3 md:w-4 md:h-4 flex-shrink-0" />
                          Événement ou vote non tenu → Remboursement automatique
                          intégral
                        </p>
                      </div>
                    </div>
          ...
          >
            ...
            <p className="text-xs md:text-sm lg:text-base text-gray-400">
              ...
              <span className="text-green-400">20% (Ville)</span>,{" "}
              <span className="text-purple-400">30% (Région)</span>,{" "}
              <span className="text-yellow-400">40% (Pays)</span>.
            </p>
            <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-3 md:p-4 mb-4">
              <p className="text-xs md:text-sm text-blue-300">
                <span className="font-bold">
                  ✅ Contrats complets multi-pages :
                </span>{" "}
                Les PDF générés contiennent l'intégralité du contrat sur
                plusieurs pages.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              ...
              <Card className="bg-[#111111] border-gray-800 hover:border-blue-500/50 transition-all">
                <CardContent className="p-4 md:p-6 space-y-3 md:space-y-4">
                  <div className="flex items-center justify-between">
                    <Badge className="bg-blue-600/20 text-blue-300 border-blue-500/50 text-xs">
                      STARTER
                    </Badge>
                    <MapPin className="w-4 h-4 md:w-5 md:h-5 text-blue-400" />
                  </div>
                  <div>
                    <h3 className="font-bold text-base md:text-xl text-white mb-0.5 md:mb-1">
                      Licence Ville
                    </h3>
                    <p className="text-xs md:text-sm text-gray-400">
                      Exclusivité territoriale urbaine
                    </p>
                  </div>
                  ...
                  <div className="text-xs text-gray-500 bg-gray-800/30 p-2 rounded">
                    <span className="text-blue-400">Prérempli :</span>{" "}
                  ...
                  <div className="mt-1 md:mt-2 pt-2 md:pt-2 border-t border-gray-800">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        (window.location.href = "/help-center?tab=contracts")
                      }
                    >
              ...
              <Card className="bg-[#111111] border-gray-800 hover:border-purple-500/50 transition-all">
                <CardContent className="p-4 md:p-6 space-y-3 md:space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs md:text-sm text-gray-400">
                      Exclusivité régionale + encadrement villes
                    </p>
                  </div>
                  <div className="space-y-1.5 md:space-y-2">
                    <div className="flex justify-between text-xs md:text-sm">
                  ...
                  <div className="text-xs text-gray-500 bg-gray-800/30 p-2 rounded">
                    <span className="text-purple-400">Prérempli :</span>{" "}
                    {BONPLANINFOS_INFO.responsable}
                  </div>
                  <Button
              ...
              <Card className="bg-[#111111] border-gray-800 hover:border-yellow-500/50 transition-all md:col-span-2 lg:col-span-1">
                <CardContent className="p-4 md:p-6 space-y-3 md:space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs md:text-sm text-gray-400">
                      Exclusivité pays + supervision nationale
                    </p>
                  </div>
                  <div className="space-y-1.5 md:space-y-2">
                    <div className="flex justify-between text-xs md:text-sm">
                  ...
                  <div className="text-xs text-gray-500 bg-gray-800/30 p-2 rounded">
                    <span className="text-yellow-400">Prérempli :</span>{" "}
                    {BONPLANINFOS_INFO.responsable}
                  </div>
                  <Button
            ...
            <Card className="bg-[#111111] border-gray-800 mt-3 md:mt-4">
              <CardContent className="p-4 md:p-6">
                <h4 className="font-bold text-white mb-3 md:mb-4 text-sm md:text-base">
                  📋 Obligations contractuelles par niveau
                </h4>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                  <div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-1 md:space-y-2 text-xs md:text-sm text-gray-400">
                      ...
                      <li className="flex items-start gap-1 md:gap-2">
                        • Encadrement concessions villes
                      </li>
                      <li className="flex items-start gap-1 md:gap-2">
                ...
                <div className="flex flex-col sm:flex-row items-start gap-3 md:gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="text-base md:text-xl font-bold text-white mb-2 md:mb-3 flex flex-wrap items-center gap-1 md:gap-2">
                      ...
                      <Badge className="bg-orange-600/20 text-orange-300 border-orange-500/50 ml-0 md:ml-2 text-xs">
                        LECTURE OBLIGATOIRE
                      </Badge>
                    </h4>
                    ...
                    <div className="space-y-4 md:space-y-6">
                      ...
                      <div className="bg-red-500/10 border border-red-500/30 p-3 md:p-5 rounded-lg">
                        <h5 className="font-bold text-white mb-2 md:mb-3 flex items-center gap-1 md:gap-2 text-sm md:text-base">
                          <span className="w-5 h-5 md:w-6 md:h-6 bg-red-500/20 rounded-full flex items-center justify-center text-xs">
                            1
                          </span>
                          Révocation pour inaction ou sous-performance
                        </h5>
                        <p className="text-xs md:text-sm text-gray-300 mb-2 md:mb-3">
                          Tout partenaire territorial (Ville, Région ou Pays)
                          qui, après avoir acquitté son droit d'entrée, ne
                          développe pas activement sa zone ou n'atteint pas les
                          objectifs contractuels pendant une période de{" "}
                          <span className="text-white font-semibold">
                            6 mois consécutifs
                          </span>{" "}
                          pourra être révoqué par la direction de BonPlanInfos.
                        </p>
                        <div className="bg-gray-800/50 p-3 md:p-4 rounded-md mt-1 md:mt-2">
                          <p className="text-orange-300 font-medium mb-1 md:mb-2 text-xs md:text-sm">
                            ➡️ Conditions de remboursement :
                          </p>
                          <p className="text-xs md:text-sm text-gray-300">
                            Le partenaire révoqué pour inaction ou
                            sous-performance percevra{" "}
                            <span className="text-green-400 font-bold">
                              50% de son droit d'entrée
                            </span>{" "}
                            à titre de dédommagement. Les 50% restants sont
                            conservés par BonPlanInfos pour couvrir les frais
                            d'administration, de recherche d'un nouveau
                            concessionnaire et de transition opérationnelle.
                          </p>
                          <p className="text-gray-400 text-xs mt-2 md:mt-3 border-t border-gray-700 pt-2 md:pt-3">
                            ⚡ Sa zone sera immédiatement réattribuée à un
                            nouveau partenaire sélectionné pour son dynamisme et
                            sa capacité à développer le territoire.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="bg-blue-500/10 border border-blue-500/30 p-3 md:p-5 rounded-lg">
                        <h5 className="font-bold text-white mb-2 md:mb-3 flex items-center gap-1 md:gap-2 text-sm md:text-base">
                          <span className="w-5 h-5 md:w-6 md:h-6 bg-blue-500/20 rounded-full flex items-center justify-center text-xs">
                            2
                          </span>
                          Démission volontaire
                        </h5>
                        <p className="text-xs md:text-sm text-gray-300 mb-2 md:mb-3">
                          Un partenaire qui, après avoir acquitté son droit
                          d'entrée, décide de ne plus représenter BonPlanInfos
                        ...
                        <div className="bg-gray-800/50 p-3 md:p-4 rounded-md mt-1 md:mt-2">
                          ...
                          <p className="text-xs md:text-sm text-gray-300">
                            <span className="text-red-400 font-bold">
                              Aucun remboursement du droit d'entrée.
                            </span>{" "}
                            La démission volontaire est considérée comme une
                            rupture unilatérale du contrat par le partenaire.
                            BonPlanInfos ne procède à aucun remboursement,
                            partiel ou total, quelle que soit la date de la
                            démission.
                          </p>
                          <p className="text-gray-400 text-xs mt-2 md:mt-3 border-t border-gray-700 pt-2 md:pt-3">
                            📌 Le partenaire démissionnaire perd immédiatement
                            son exclusivité territoriale et ses droits sur les
                            commissions futures.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="bg-gray-800/30 p-3 md:p-5 rounded-lg border border-gray-700">
                        <h5 className="font-bold text-white mb-2 md:mb-3 text-sm md:text-base">
                          📊 Récapitulatif des conditions de remboursement
                        </h5>
                            ...
                            <table className="min-w-full text-xs md:text-sm">
                              <thead>
                                <tr className="border-b border-gray-700">
                                  <th className="text-left py-1.5 md:py-2 pr-2 md:pr-4 text-gray-300">
                                    Situation
                                  </th>
                                  <th className="text-left py-1.5 md:py-2 px-2 md:px-4 text-gray-300">
                                    Remboursement
                                  </th>
                                  <th className="text-left py-1.5 md:py-2 pl-2 md:pl-4 text-gray-300">
                                    Réattribution zone
                                  </th>
                                </tr>
                              </thead>
                              <tbody>
                                <tr className="border-b border-gray-800">
                                  <td className="py-2 md:py-3 pr-2 md:pr-4 text-gray-400">
                                    Révocation pour inaction / sous-performance
                                  </td>
                                  <td className="py-2 md:py-3 px-2 md:px-4 text-green-400 font-medium">
                                    50% du droit d'entrée
                                  </td>
                                  <td className="py-2 md:py-3 pl-2 md:pl-4 text-white">
                                    Oui
                                  </td>
                                </tr>
                                <tr>
                                  ...
                                  <td className="py-2 md:py-3 px-2 md:px-4 text-red-400 font-medium">
                                    0% - Aucun
                                  </td>
                                  <td className="py-2 md:py-3 pl-2 md:pl-4 text-white">
                                    Oui
                        ...
                        <p className="text-xs text-gray-500 mt-3 md:mt-4 italic">
                          * Tout remboursement partiel (50%) intervient
                          uniquement dans le cas d'une révocation décidée par
                          BonPlanInfos pour manque de résultats. Aucune
                          démission volontaire n'ouvre droit à remboursement.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-3 md:space-y-4 max-h-60 md:max-h-96 overflow-y-auto pr-2 md:pr-4 custom-scrollbar mt-4 md:mt-6">
                  <div className="bg-gray-800/30 p-3 md:p-4 rounded-lg">
                    ...
                    <p className="text-gray-400 text-xs md:text-sm">
                      ...
                      dans lesquelles la plateforme BonPlanInfos met à
                      disposition de l'Organisateur des outils digitaux lui
                      permettant :
                    </p>
                    ...
                    <p className="text-gray-400 text-xs md:text-sm mt-1 md:mt-2">
                      BonPlanInfos agit exclusivement en tant que prestataire
                      technique et intermédiaire de paiement.
                    </p>
                  </div>

                  <div className="bg-gray-800/30 p-3 md:p-4 rounded-lg">
                    <h4 className="font-bold text-white mb-1 md:mb-2 text-sm md:text-base">
                      ARTICLE 2 — STATUT DES PARTIES
                    </h4>
                    <p className="text-gray-400 text-xs md:text-sm">
                      BonPlanInfos n'est ni organisateur, ni co-organisateur des
                      événements publiés.
                      <br />
                      L'Organisateur est seul responsable de la conception, de
                      l'organisation, du contenu et du bon déroulement de son
                      événement.
                      <br />
                      Aucun lien de subordination, de partenariat juridique ou
                      d'association n'est créé par le présent contrat.
                    </p>
                  </div>

                  <div className="bg-gray-800/30 p-3 md:p-4 rounded-lg">
                    <h4 className="font-bold text-white mb-1 md:mb-2 text-sm md:text-base">
                      ARTICLE 4 — COMMISSION ET RÉMUNÉRATION
                    </h4>
                    <div className="space-y-1 md:space-y-2">
                      <p className="text-white font-semibold text-xs md:text-sm">
                        4.1 Commission plateforme
                      </p>
                      <p className="text-gray-400 text-xs md:text-sm">
                      ...
                      <ul className="list-disc list-inside text-gray-400 text-xs md:text-sm ml-2 md:ml-4 space-y-0.5 md:space-y-1">
                        <li>
                          chaque participation payante (billet, vote, tombola,
                          stand)
                        </li>
                  ...
                  <div className="bg-gray-800/30 p-3 md:p-4 rounded-lg">
                    <h4 className="font-bold text-white mb-1 md:mb-2 text-sm md:text-base">
                      ARTICLE 5 — RESPONSABILITÉS DE L'ORGANISATEUR
                    </h4>
                    <p className="text-gray-400 text-xs md:text-sm">
                    ...
                    <ul className="list-disc list-inside text-gray-400 text-xs md:text-sm mt-1 md:mt-2 space-y-0.5 md:space-y-1">
                      ...
                      <li>
                        de la délivrance des prestations promises aux
                        participants
                      </li>
                  ...
                  <div className="bg-red-500/10 border border-red-500/30 p-3 md:p-4 rounded-lg">
                    ...
                    <p className="text-gray-400 text-xs md:text-sm">
                      BonPlanInfos ne pourra être tenue responsable des pertes
                      indirectes, des dommages liés à l'organisation de
                      l'événement, ou des décisions prises par l'Organisateur.
                    </p>
                  </div>
                </div>

                <div className="mt-4 md:mt-6 p-3 md:p-4 bg-blue-900/20 border border-blue-500/30 rounded-lg">
                  <p className="text-blue-300 font-semibold mb-1 md:mb-2 text-sm md:text-base">
                    ✅ ACCEPTATION OBLIGATOIRE
                  </p>
                  <p className="text-gray-400 text-xs md:text-sm mb-3 md:mb-4">
                    En créant un compte Organisateur et en publiant un événement
                    sur BonPlanInfos, l'Organisateur reconnaît avoir lu, compris
                    et accepté sans réserve le présent contrat.
                  </p>
                  <div className="flex items-center gap-2 bg-gray-800/50 p-2 md:p-3 rounded">
                    <input
                      type="checkbox"
                      id="accept"
                      className="rounded bg-gray-700 border-gray-600 w-3 h-3 md:w-4 md:h-4"
                    />
                    <label
                      htmlFor="accept"
          ...
          >
            ...
            <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-3 md:p-4 flex items-center gap-2 md:gap-3">
              ...
              <span className="font-medium text-red-300 text-xs md:text-sm">
                Tolérance Zéro pour la fraude.
              </span>
            </div>
            <p className="text-xs md:text-sm text-gray-400">
              Notre système utilise des algorithmes automatisés pour détecter
              les comportements suspects (achats massifs par même IP, taux de
              scan incohérents, plaintes multiples). Tout compte suspecté est
              immédiatement{" "}
              <span className="text-red-400 font-semibold">gelé</span> le temps
              de l'investigation. En cas de fraude avérée, les fonds sont
              bloqués définitivement et reversés aux participants lésés.
            </p>
          </section>
            ...
            <div className="space-y-3 md:space-y-4">
              <details className="group bg-[#111111] p-3 md:p-4 rounded-lg border border-gray-800 cursor-pointer hover:border-gray-700 transition-colors">
                ...
                <p className="text-gray-400 mt-2 md:mt-3 text-xs md:text-sm border-t border-gray-800 pt-2 md:pt-3">
                  Les fonds disponibles (débloqués) peuvent être retirés à tout
                  moment via Mobile Money ou Virement. Le solde bloqué attend la
              ...
              <details className="group bg-[#111111] p-3 md:p-4 rounded-lg border border-gray-800 cursor-pointer hover:border-gray-700 transition-colors">
                ...
                <p className="text-gray-400 mt-2 md:mt-3 text-xs md:text-sm border-t border-gray-800 pt-2 md:pt-3">
                  Contactez le support via le centre d'aide. Fournissez toutes
                  les preuves. Les fonds liés à l'événement seront gelés jusqu'à
                  résolution.
                </p>
              </details>
              ...
              <details className="group bg-[#111111] p-3 md:p-4 rounded-lg border border-gray-800 cursor-pointer hover:border-gray-700 transition-colors">
                <summary className="flex justify-between items-center font-medium text-white list-none text-sm md:text-base">
                  Comment sont calculées les commissions des partenaires
                  territoriaux ?
                  <span className="transition group-open:rotate-90 text-gray-400">
                    <ChevronRight className="w-4 h-4 md:w-5 md:h-5" />
                  </span>
              ...
              <details className="group bg-[#111111] p-3 md:p-4 rounded-lg border border-gray-800 cursor-pointer hover:border-gray-700 transition-colors">
                <summary className="flex justify-between items-center font-medium text-white list-none text-sm md:text-base">
                  Quelles sont les conditions de remboursement pour une tombola
                  annulée ?
                  <span className="transition group-open:rotate-90 text-gray-400">
                    <ChevronRight className="w-4 h-4 md:w-5 md:h-5" />
                  </span>
                ...
                <p className="text-gray-400 mt-2 md:mt-3 text-xs md:text-sm border-t border-gray-800 pt-2 md:pt-3">
                  Si le tirage n'a pas eu lieu ou si le lot n'a pas été déposé,
                  tous les participants sont automatiquement remboursés
                  intégralement. Les fonds sont sous séquestre et ne peuvent
                  être débloqués qu'après confirmation du dépôt et de la remise
                  effective du lot au gagnant.
                </p>
              </details>
              ...
              <details className="group bg-[#111111] p-3 md:p-4 rounded-lg border border-gray-800 cursor-pointer hover:border-gray-700 transition-colors">
                ...
                <p className="text-gray-400 mt-2 md:mt-3 text-xs md:text-sm border-t border-gray-800 pt-2 md:pt-3">
                  Oui, uniquement en cas de révocation pour inaction ou
                  sous-performance : remboursement de 50% du droit d'entrée. En
                  cas de démission volontaire, aucun remboursement n'est
                  accordé.
                </p>
              </details>
