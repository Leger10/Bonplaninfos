...
const CreatePromotionPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const packInfo = promotionPacks.find(
        (p) => p.id === formData.promotion_pack_id,
      );
      ...
      const onSuccess = async () => {
        try {
          await CoinService.debitCoins(
            user.id,
            packInfo.cost_pi,
            `Promotion pour l'événement ID: ${formData.event_id}`,
          );
          ...
          const { data, error } = await supabase
            ...
            .insert({
              ...
              event_end_at: new Date(
                Date.now() + packInfo.duration_days * 24 * 60 * 60 * 1000,
              ).toISOString(),
          ...
          toast({
            ...
            description: "Votre événement est maintenant promu.",
          });
          ...
          toast({
            ...
            description:
              "Votre paiement a réussi, mais la mise à jour de la promotion a échoué. Veuillez contacter le support.",
            variant: "destructive",
          });
        }
      };
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta
          name="description"
          content="Promouvez votre événement sur BonPlaninfos."
        />
      </Helmet>
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <p className="text-muted-foreground">
            Augmentez la visibilité de votre événement pour toucher plus de
            monde.
          </p>
        </motion.div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <CardContent className="space-y-6">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      handleInputChange("event_id", value)
                    }
                  >
                    <SelectTrigger
                      id="event_id"
              ...
              <CardContent>
                <div className="space-y-2">
                  ...
                  {loadingPacks ? (
                    ...
                    <Select
                      value={formData.promotion_pack_id}
                      onValueChange={(value) =>
                        handleInputChange("promotion_pack_id", value)
                      }
                    >
                          ...
                          >
                            <div className="flex items-center justify-between w-full min-w-[200px] gap-4">
                              <span className="font-medium">
                                {pack.name} ({pack.duration_days} jours)
                              </span>
                  ...
                  <p className="text-sm text-muted-foreground mt-2">
                    Le coût en pièces sera déduit de votre portefeuille lors de
                    la publication. Si votre solde est insuffisant, vous serez
                    redirigé vers la page des packs.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              ...
              <Button
                type="submit"
                disabled={
                  loading || !formData.event_id || !formData.promotion_pack_id
                }
                className="gradient-gold text-background hover:opacity-90 flex-1"
              >
                {loading ? (
                  <>
