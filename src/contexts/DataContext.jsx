...
export const DataProvider = ({ children }) => {
  ...
  const [notificationBellAnimation, setNotificationBellAnimation] = useState(0);
  ...
  const triggerNotificationBellAnimation = useCallback(() => {
    setNotificationBellAnimation(prev => prev + 1);
  }, []);
      ...
      const channel = supabase
        ...
        .on('postgres_changes', 
          ...
          (payload) => {
            ...
            const isTargetUser = newNotification.user_id === user.id;
  ...
  }, [user, supabase, triggerSoundEffect, triggerVisualEffect, triggerNotificationBellAnimation]);
