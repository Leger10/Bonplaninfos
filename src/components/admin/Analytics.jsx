...
const Analytics = () => {
  ...
  const fetchDashboardData = useCallback(async (forceRefresh = false) => {
    ...
    try {
      ...
      const analyticsData =
        analyticsRpc.data && analyticsRpc.data[0] ? analyticsRpc.data[0] : {};
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {globalStats.totalRevenue.toLocaleString()} F CFA
                </div>
        ...
        <TabsContent value="transactions" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Les 10 dernières transactions effectuées sur la plateforme.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {loading ? (
                  ...
                  {recentTransactions.map((transaction) => (
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <div
                          className={`p-2 rounded-full ${transaction.amount_pi > 0 ? "bg-green-500/10 text-green-500" : "bg-red-500/10 text-red-500"}`}
                        >
                      ...
                      <div className="text-right">
                        <span
                          className={`font-bold ${transaction.amount_pi > 0 ? "text-green-500" : "text-red-500"}`}
                        >
                          {transaction.amount_pi > 0 ? "+" : ""}
                          {transaction.amount_pi} pièces
                        </span>
                      </div>
                    </div>
                  ))}
