    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      <div className="lg:col-span-1">
        <Card className="glass-effect">
          <CardHeader>
            <CardTitle>Créditer un Utilisateur</CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleCredit} className="space-y-4">
              ...
              {searchTerm && (
                <div>
                  ...
                  <Select onValueChange={(value) => setSelectedUser(users.find(u => u.id === value))}>
                    <SelectTrigger id="user-select"><SelectValue placeholder="Sélectionner..." /></SelectTrigger>
                    <SelectContent>
                      {filteredUsers.map(u => (
              ...
              <div>
                ...
                <Input id="amount" type="number" value={amount} onChange={(e) => setAmount(e.target.value)} placeholder="ex: 100" />
              </div>
              <div>
                <Label htmlFor="reason">Raison (optionnel)</Label>
                <Input id="reason" type="text" value={reason} onChange={(e) => setReason(e.target.value)} placeholder="ex: Bonus de bienvenue" />
              </div>
