...
const EventCard = ({ event, onClick, isUnlocked }) => {
  ...
  return (
    ...
    >
      <Card 
        className="h-full card-hover glass-effect border-border/20 overflow-hidden flex flex-col flex-grow"
      >
        <div className="relative">
          ...
          {isProtectedAndLocked && (
            <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-center p-4 backdrop-blur-sm group-hover:backdrop-blur-none transition-all duration-300">
