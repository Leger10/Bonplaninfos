...
const Seo = ({
  ...
  const siteName =
    "BonPlanInfos - Votre Guide Événements & Récompenses en Afrique";
  const siteUrl = "https://www.bonplaninfos.net";
  const defaultTitle =
    "🎯 BonPlanInfos • Événements Exclusifs + Gagnez de l'Argent + organiser vos événements 💰";
  const defaultDescription =
    "🚀 Découvrez les événements tendance, concerts VIP et bons plans cachés. Gagnez des récompenses sur chaque partage ! 🎁 Rejoignez la communauté #1 en Afrique.";
  ...
  return (
    <Helmet>
      ...
      <meta
        property="og:locale"
        content={currentLanguage === "fr" ? "fr_FR" : "en_US"}
      />
